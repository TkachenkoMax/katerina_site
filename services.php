...
<body>
	...
	<div class="servicesBIG">
		...
		<div class="services-content">
			<div class="category-title">Услуги</div>
			<div class="category-news-left">
				<?php 
					$lastnews = mysqli_query($connect,"SELECT id, title, description, date, author FROM news WHERE category = 'Услуги' ORDER BY id DESC");
